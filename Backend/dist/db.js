...
exports.database_connection = void 0;
...
function database_connection(pos_collections) {
    return __awaiter(this, void 0, void 0, function () {
        var db_1, collection, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // Connect the client to the server	(optional starting in v4.7)
                    _a.sent();
                    return [4 /*yield*/, client.db("pos_system")];
                case 2:
                    db_1 = _a.sent();
                    collection = pos_collections.map(function (element) {
                        return db_1.collection(element);
                    });
