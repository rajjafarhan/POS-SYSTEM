    ...
    return(
        ...
        <div style={{backgroundColor:"#daeaf0"}} className="container-fluid banner ">
            <div className="row  banner">
                ...
                <div className="col-md-4 bannerimg " style={{display:"flex",justifyContent:"center",alignItems:"center"}}>
                    <img   src="https://img.freepik.com/free-vector/bathroom-interior-realistic-design_1284-14400.jpg?w=826&t=st=1696772223~exp=1696772823~hmac=18cbeb7d46e562bc4794ce437d5bc9497eec9f411f400794d526228aeb470929"alt="uu" />
